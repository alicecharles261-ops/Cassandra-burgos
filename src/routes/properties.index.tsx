...
export const Route = createFileRoute("/properties/")({
  ...
  head: () => ({
    meta: [
      { title: "All Properties — Cassandra Burgos | DFW Real Estate" },
      {
        name: "description",
        content:
          "Browse every DFW listing represented by Cassandra Burgos — for sale, for lease, sold, and leased. Search by city, price, and bedrooms.",
      },
      { property: "og:title", content: "All Properties — Cassandra Burgos" },
      {
        property: "og:description",
        content: "Search DFW homes for sale and lease with Cassandra Burgos.",
      },
      { property: "og:url", content: "/properties" },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "All Properties — Cassandra Burgos" },
      { name: "twitter:description", content: "Search DFW homes for sale and lease." },
    ],
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="pt-32 pb-10 container-luxury">
        ...
        <h1 className="mt-4 font-serif text-4xl md:text-6xl">The DFW collection</h1>
        <p className="mt-4 max-w-2xl text-muted-foreground">
          Every home represented by Cassandra Burgos, searchable by city, price, bedrooms, and status.
        </p>
      </section>
