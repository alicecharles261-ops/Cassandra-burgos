...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      { title: "Cassandra Burgos — Real Estate Agent | Dallas–Fort Worth, TX" },
      {
        name: "description",
        content:
          "Concierge real estate in the DFW Metroplex. Buy, sell, lease, and invest with Cassandra Burgos — professional, local, and client-focused.",
      },
      { property: "og:title", content: "Cassandra Burgos — DFW Real Estate" },
      {
        property: "og:description",
        content:
          "Helping you find the perfect home. Buying, selling, leasing, investing across Dallas–Fort Worth.",
      },
      { property: "og:url", content: "/" },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "Cassandra Burgos — DFW Real Estate" },
      {
        name: "twitter:description",
        content: "Concierge DFW real estate — buying, selling, leasing, investing.",
      },
    ],
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section id="home" className="relative min-h-[100svh] flex items-end pt-24">
        ...
        <div className="container-luxury relative z-10 pb-20 md:pb-28 text-white">
          <p className="gold-rule text-gold">DFW · Concierge Real Estate</p>
        ...
        <div className="container-luxury">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-14">
            ...
            <p className="max-w-md text-sm text-muted-foreground">
              A hand-picked selection across the Dallas–Fort Worth Metroplex — from turn-key
      ...
      <section id="about" className="py-24 md:py-32 bg-foreground text-background">
        <div className="container-luxury grid gap-14 lg:grid-cols-2 items-center">
          <div className="relative">
            ...
            <img
              src={portrait}
              alt="Portrait of Cassandra Burgos"
          ...
          <div>
            <p className="gold-rule text-gold">About Cassandra</p>
            <h2 className="mt-4 font-serif text-4xl md:text-5xl">
              A trusted advisor for every move
            </h2>
            <p className="mt-6 text-base leading-relaxed text-background/80">
              Cassandra Burgos is a Dallas–Fort Worth real estate agent with a reputation for
            ...
            <div className="mt-10 grid grid-cols-3 gap-6 max-w-md">
              ...
              <div>
                <div className="font-serif text-4xl text-gold">DFW</div>
      ...
      <section className="py-24 md:py-32">
        <div className="container-luxury">
          <div className="text-center mb-14">
            <p className="gold-rule">Why Choose Cassandra</p>
        ...
        <div className="container-luxury grid gap-14 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-6 text-muted-foreground max-w-md leading-relaxed">
              Tell Cassandra about your goals — a home to buy, a property to sell, an apartment to
      ...
      <section className="py-20 bg-foreground text-background">
        <div className="container-luxury text-center">
          ...
          <h2 className="mt-6 font-serif text-4xl md:text-5xl">Follow Cassandra on Instagram</h2>
